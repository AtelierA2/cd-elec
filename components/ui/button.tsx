...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-white hover:bg-primary-700 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg",
        secondary:
          "bg-accent text-neutral-900 hover:bg-accent-500 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg",
        outline:
          "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-white hover:scale-105 active:scale-95",
        ghost: "text-primary hover:bg-primary-50 hover:scale-105 active:scale-95",
